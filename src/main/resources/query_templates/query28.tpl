...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between [LISTPRICE.1] and [LISTPRICE.1]+10 
             ...
             or ss_wholesale_cost between [WHOLESALECOST.1] and [WHOLESALECOST.1]+20)) B1 join
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between [LISTPRICE.2] and [LISTPRICE.2]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.2] and [WHOLESALECOST.2]+20)) B2 join
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between [LISTPRICE.3] and [LISTPRICE.3]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.3] and [WHOLESALECOST.3]+20)) B3 join
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between [LISTPRICE.4] and [LISTPRICE.4]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.4] and [WHOLESALECOST.4]+20)) B4 join
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between [LISTPRICE.5] and [LISTPRICE.5]+10
          ...
          or ss_wholesale_cost between [WHOLESALECOST.5] and [WHOLESALECOST.5]+20)) B5 join
